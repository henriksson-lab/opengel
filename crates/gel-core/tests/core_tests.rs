use gel_core::hdr::merge_hdr;
use gel_core::imagef32::GrayF32;
use gel_core::model::CaptureMeta;
use gel_core::quant::{compare, mass_ng_to_nmol, nmol_to_molar, SizingFit};
use gel_core::{ladders, Calibration, GelDocument, GelType};
...
fn gel_zip_roundtrip() {
    ...
    doc.project.analysis.lanes.push(gel_core::Lane {
        id: 0,
        x_min: 2,
        x_max: 14,
        y_min: 0,
