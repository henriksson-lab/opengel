use gel_core::model::{GelType, LadderBand, LadderTemplate};
use gel_core::GrayF32;
use gel_detect::detector::{DetectParams, GelDetector};
use gel_detect::eval::{aggregate, evaluate, GroundTruth, GtBand, GtLane};
use gel_detect::{analyze, ClassicalDetector};
use ndarray::Array2;
